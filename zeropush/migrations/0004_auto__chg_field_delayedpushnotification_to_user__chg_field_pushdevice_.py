...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PushDevice.user'
        db.alter_column(u'zeropush_pushdevice', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[AUTH_USER_MODEL], null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PushDevice.user'
        raise RuntimeError("Cannot reverse this migration. 'PushDevice.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PushDevice.user'
        db.alter_column(u'zeropush_pushdevice', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[AUTH_USER_MODEL]))
