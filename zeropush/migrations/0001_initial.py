...
class Migration(SchemaMigration):
    ...
    models = {
        u'settings.AUTH_USER_MODEL': {
            ...
            'followers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'follows'", 'symmetrical': 'False', 'to': u"orm['%s']" % settings.AUTH_USER_MODEL}),
